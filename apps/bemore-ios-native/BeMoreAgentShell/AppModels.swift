...
struct StackConfig: Codable {
    ...
    var onboardingAppearanceProfileName: String?
    var onboardingAppearanceArchetype: String?
    var onboardingAppearancePalette: String?
    ...
    static let `default` = StackConfig(
        ...
        onboardingAppearanceProfileName: nil,
        onboardingAppearanceArchetype: nil,
        onboardingAppearancePalette: nil,
