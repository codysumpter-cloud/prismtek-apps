...
enum AppTab: String, Codable, CaseIterable, Hashable, Identifiable {
    ...
    var systemImage: String {
        ...
        case .buddyMon: return "pawprint.circle.fill"
...
struct ShellPreferences: Codable, Hashable {
    ...
    static let `default` = ShellPreferences(
        orderedTabs: [.missionControl, .buddy, .buddyMon, .chat, .editor, .models, .artifacts, .files, .settings, .pairing, .pricing],
    ...
    func normalized() -> ShellPreferences {
        ...
        hidden.subtract([.buddy, .buddyMon, .chat, .editor, .models, .artifacts, .files, .settings])
