...
struct ShellPreferences: Codable, Hashable {
    ...
    static let `default` = ShellPreferences(
        orderedTabs: [.missionControl, .buddy, .chat, .hermes, .editor, .models, .artifacts, .files, .settings, .pairing, .pricing],
    ...
    func normalized() -> ShellPreferences {
        ...
        hidden.subtract([.buddy, .chat, .hermes, .editor, .models, .artifacts, .files, .settings])
