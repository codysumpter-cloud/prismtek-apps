...
## Keep in `bmo-stack` for now when it is about
...
If a working automation path currently lives in `bmo-stack` but clearly serves the BeMore product, treat it as transitional:
