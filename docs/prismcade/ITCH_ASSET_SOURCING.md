...
## How this plugs into PR #187

PR #187 already added `data/prismcade/repo-asset-packs.json` for repo-local assets. External itch.io candidates should be added later as a separate `external` section or imported only after their receipt exists.
